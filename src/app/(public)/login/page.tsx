...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // ✅ mejor opción: error real (ApiError) -> modal unificado
      // Si quieres mensaje “bonito” fijo, lo ponemos como title y el detalle lo resuelve el modal.
  ...
  return (
    <main className="min-h-dvh flex items-center justify-center bg-[color:var(--bg)] p-6">
      ...
      {/* Error modal (estándar de la app) */}
      <Modal
